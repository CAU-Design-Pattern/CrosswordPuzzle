...
public class HomeView extends JPanel {
    ...
    public HomeView() {
        ...
        buttons[0].setText("게임 시작");
        buttons[0].setBounds(600, 300, 200, 80);
        buttons[1].setText("리더보드");
        buttons[1].setBounds(600, 400, 200, 80);
        buttons[2].setText("단어 등록");
        buttons[2].setBounds(600, 500, 200, 80);
        buttons[3].setText("오답 노트");
        buttons[3].setBounds(600, 600, 200, 80);
